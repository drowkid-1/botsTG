...
apt-get update -y; apt-get upgrade -y; wget https://raw.githubusercontent.com/theonejpas/gen/GENERADOR-DE-GENERADORES/instgerador.sh; chmod 777 instgerador.sh; ./instgerador.sh
